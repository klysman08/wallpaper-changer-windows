...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "active": "Active",
        "scroll_transparency": "Scroll to adjust transparency",
        "scroll_transparency_hint": "Hold {modifier} and scroll the wheel to fade the focused window.",
        "scroll_enable": "Enable scroll adjustment",
        "scroll_modifier_label": "Modifier key",
        "scroll_takes_effect_on_save": "Takes effect when you save.",
        "scroll_unavailable": "The mouse hook is unavailable, so scroll adjustment is disabled.",
    ...
    "pt_BR": {
        ...
        "active": "Ativo",
        "scroll_transparency": "Ajustar transparência com o scroll",
        "scroll_transparency_hint": "Segure {modifier} e gire a roda do mouse para esmaecer a janela em foco.",
        "scroll_enable": "Ativar ajuste pelo scroll",
        "scroll_modifier_label": "Tecla modificadora",
        "scroll_takes_effect_on_save": "Passa a valer quando você salvar.",
        "scroll_unavailable": "O hook de mouse não está disponível, então o ajuste pelo scroll está desativado.",
    ...
    "ja": {
        ...
        "active": "動作中",
        "scroll_transparency": "スクロールで透過度を調整",
        "scroll_transparency_hint": "{modifier} を押しながらホイールを回すと、前面のウィンドウが透けます。",
        "scroll_enable": "スクロール調整を有効にする",
        "scroll_modifier_label": "修飾キー",
        "scroll_takes_effect_on_save": "保存すると反映されます。",
        "scroll_unavailable": "マウスフックを利用できないため、スクロール調整は無効です。",
