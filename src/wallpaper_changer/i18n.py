...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "startup": "Startup",
        "start_with_windows_hint": "Launch automatically when you sign in, straight to the tray.",
        "start_minimized": "Start minimized in the tray",
        "start_minimized_hint": "Also applies when you open the app yourself. The tray icon reopens the window.",
        "resume_last_session_hint": "Rotation and the video wallpaper come back the way you left them.",
        ...
        "preview_save": "Save as image",
        "preview_save_which": "Which screen to save",
        "monitor_n": "Monitor {n}",
        "collage_saved": "Collage saved",
        "collage_save_failed": "Could not save the collage",
        "gallery": "Saved collages",
        "gallery_empty": "No saved collages yet",
        "gallery_empty_hint": (
        ...
        "gallery_remove": "Remove from library",
        "gallery_removed": "Removed from the library. The file was kept.",
        "gallery_remove_hint": "Removes the entry from this list. The image file stays where it is.",
        "gallery_count": "{count} saved",
        ...
        "auto_check_updates": "Check for updates at startup",
        "auto_check_updates_hint": (
        ...
        "update_ready_restart": "The update is ready. The app will restart to finish.",
    ...
    "pt_BR": {
        ...
        "start_with_windows_hint": "Abre sozinho ao entrar no Windows, direto na bandeja.",
        "start_minimized": "Iniciar minimizado na bandeja",
        "start_minimized_hint": "Vale também quando você abre o app. O ícone da bandeja traz a janela de volta.",
        "resume_last_session_hint": "A rotação e o wallpaper de vídeo voltam como você deixou.",
        ...
        "loading": "Carregando...",
        "shuffle": "Sortear",
        "preview_all": "Todos os monitores",
        "preview_expand": "Ampliar pré-visualização",
        ...
        "preview_save": "Salvar como imagem",
        "preview_save_which": "Qual tela salvar",
        "monitor_n": "Monitor {n}",
        "collage_saved": "Collage salva",
        "collage_save_failed": "Não foi possível salvar a collage",
        "gallery": "Collages salvas",
        "gallery_empty": "Nenhuma collage salva ainda",
        "gallery_empty_hint": (
            "Use “Salvar como imagem” acima da pré-visualização para guardar uma "
            "collage aqui."
        ),
        ...
        "gallery_remove": "Remover da biblioteca",
        "gallery_removed": "Removida da biblioteca. O arquivo foi mantido.",
        "gallery_remove_hint": "Remove o item desta lista. O arquivo de imagem continua onde está.",
        "gallery_count": "{count} salvas",
        ...
        "new_version_available": "A versão {version} está disponível",
        "check_for_updates": "Procurar atualizações",
        "checking_for_updates": "Procurando...",
        "up_to_date": "Você já está na versão mais recente",
        "update_check_failed": "Não foi possível procurar atualizações",
        "auto_check_updates": "Procurar atualizações ao iniciar",
        "auto_check_updates_hint": (
            "Pergunta ao GitHub uma vez por inicialização "
            "se existe uma versão mais nova."
        ),
        "release_notes": "Novidades",
        "download_and_install": "Baixar e instalar",
        "downloading_update": "Baixando...",
        "update_ready_restart": (
            "A atualização está pronta. O aplicativo será reiniciado para concluir."
        ),
    ...
    "ja": {
        ...
        "startup": "起動",
        "start_with_windows_hint": "サインイン時に自動で起動し、トレイに常駐します。",
        "start_minimized": "トレイに最小化した状態で起動",
        "start_minimized_hint": "手動で開いたときも同じ動作になります。トレイアイコンでウィンドウを再表示できます。",
        "resume_last_session_hint": "ローテーションと動画壁紙は前回の状態のまま復帰します。",
        ...
        "loading": "読み込み中...",
        "shuffle": "シャッフル",
        "preview_all": "すべてのモニター",
        "preview_expand": "プレビューを拡大",
        "preview_close": "閉じる",
        ...
        "preview_save": "画像として保存",
        "preview_save_which": "保存する画面",
        "monitor_n": "モニター {n}",
        "collage_saved": "コラージュを保存しました",
        "collage_save_failed": "コラージュを保存できませんでした",
        "gallery": "保存したコラージュ",
        "gallery_empty": "保存したコラージュはまだありません",
        "gallery_empty_hint": (
        ...
        "gallery_remove": "ライブラリから削除",
        "gallery_removed": "ライブラリから削除しました。ファイルは残っています。",
        "gallery_remove_hint": "この一覧から項目を外すだけで、画像ファイルはそのまま残ります。",
        "gallery_count": "{count} 件を保存済み",
